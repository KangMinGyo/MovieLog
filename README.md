...
<details>
  <summary>홈 화면 상세 내용</summary>
  Firebase를 통해 지금까지 작성한 리뷰들을 홈 화면에 불러옵니다.<br>
  UICollectionViewDiffableDataSource를 적용해 데이터의 변화에 유연하게 대응할 수 있습니다.<br>
</details>
...
<details>
  <summary>영화 상세 화면 상세 내용</summary>
  Firebase를 통해 지금까지 작성한 리뷰들을 홈 화면에 불러옵니다.<br>
  UICollectionViewDiffableDataSource를 적용해 데이터의 변화에 유연하게 대응할 수 있습니다.<br>
</details>
...
<details>
  <summary>영화 검색 화면 상세 내용</summary>
  리뷰를 작성할 영화의 제목을 검색합니다.<br>
  만약 영화가 존재하지 않는다면, 직접 영화 정보를 추가 할 수도 있습니다.<br>
</details>
...
<details>
  <summary>리뷰 작성 화면 상세 내용</summary>
  리뷰를 작성할 영화의 제목을 선택한 뒤 리뷰를 작성합니다.<br>
  영화가 어땠는지, 어떤 점이 좋았는지, 상세 리뷰를 작성할 수 있습니다.<br>
...
<details>
  <summary>로그인, 로그아웃 상세 내용</summary>
  이메일, 애플 로그인이 가능합니다.<br>
  로그아웃이 가능합니다.<br>
</details>
...
<details>
  <summary>회원가입 상세 내용</summary>
  보안상의 문제인지 비밀번호를 입력했음에도 불구하고 캡쳐하니 아예 안뜨는데 참고해주세요.<br>
  이메일, 비밀번호, 비밀번호 확인이 전부 통과되어야만 회원가입 버튼이 작동합니다.<br>
</details>
